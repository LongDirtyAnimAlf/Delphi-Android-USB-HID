...
type
  ...
  JUsbDeviceClass = interface(JObjectClass)
    ...
    function getManufacturerName : JString; cdecl; overload;                    // ()Ljava/lang/String; A: $1
    function getManufacturerName(id : Integer) : JString; cdecl; overload;      // (I)Ljava/lang/String; A: $9
